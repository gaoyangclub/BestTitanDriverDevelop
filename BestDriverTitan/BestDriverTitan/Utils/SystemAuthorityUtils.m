...
+(void)checkLocationAuthority{
    ...
    if ([CLLocationManager locationServicesEnabled])
    {
        ...
        {
            //用户拒绝开启用户权限
            UIAlertController* alertController = [UIAlertController alertControllerWithTitle:@"打开[定位服务权限]来允许[XXX]确定您的位置" message:@"请在系统设置中开启定位服务(设置>隐私>定位服务>开启)" preferredStyle:UIAlertControllerStyleAlert];
