...
@property(nonatomic,assign) double actualReceivedWeight;//重量 精确6位小数
@property(nonatomic,assign) double actualReceivedVolume;//体积 精确6位小数
@property(nonatomic,assign) NSInteger itemCount;//内件数量

@property(nonatomic,assign) NSInteger orgPacakageUnitCount;//下单包装数量 ,
@property(nonatomic,assign) double orgWeight;//下单重量 ,
@property(nonatomic,assign) double orgVolume;//下单体积 ,
