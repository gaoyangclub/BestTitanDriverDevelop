...
#define COLOR_TEXT_PRIMARY rgba(95,95,95,1)
...
#define COLOR_NAVI_TITLE COLOR_TEXT_PRIMARY//FlatGrayDark
...
#define NAVIGATION_TITLE_ORDER_VIEW @"活动上报"
#define NAVIGATION_TITLE_ORDER_DETAIL @"订单详情"
...
#define PAGE_MENU_HEIGHT rpx(45)

#define MORE_BUTTON_RADIUS rpx(20)

#define SUBMIT_BUTTON_HEIGHT rpx(50)

#define LOCATION_INFO_CELL_HEIGHT rpx(50)

#define TASK_VIEW_CELL_HEIGHT rpx(135) //240
#define TASK_VIEW_SECTION_HEIGHT rpx(35)//(SCREEN_WIDTH > IPHONE_5S_WIDTH ? 35 : 25)

//#define TASK_TRIP_AREA_HEIGHT 140

#define TASK_TRIP_FILTER_HEIGHT rpx(45)

#define TASK_TRIP_CELL_HEIGHT rpx(120)//460 - TASK_TRIP_AREA_HEIGHT
#define TASK_TRIP_SECTION_TOP_HEIGHT rpx(45)
#define TASK_TRIP_SECTION_HEIGHT rpx(50)// + TASK_TRIP_AREA_HEIGHT

#define ORDER_TAB_WIDTH rpx(120)
#define ORDER_TAB_HEIGHT rpx(45)
#define ORDER_VIEW_CELL_HEIGHT rpx(40)//150
#define ORDER_VIEW_SECTION_HEIGHT rpx(60)

#define ORDER_PHOTO_CELL_HEIGHT rpx(100)
#define ORDER_RECEIPT_CELL_HEIGHT 0

#define MESSAGE_VIEW_SECTION_HEIGHT rpx(40)
