...
#define COLOR_YI_WAN_CHENG rgba(21,178,168,1)
#define COLOR_DAI_WAN_CHENG rgba(240,129,69,1)
...
#define ICON_SHI_JIAN @"\U0000e69f"
#define ICON_JU_LI @"\U0000e61a"
#define ICON_JIN_QIAN @"\U0000e6e5"
