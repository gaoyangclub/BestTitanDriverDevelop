...
-(ASTextNode *)sourceCodeIcon{
    if (!_sourceCodeIcon) {
        ...
        _sourceCodeIcon.attributedString = [NSString simpleAttributedString:ICON_FONT_NAME color:COLOR_TEXT_PRIMARY size:rpx(30) content:ICON_TIAO_MA];
...
-(ASTextNode *)weightLabel{
    if(!_weightLabel){
        ...
        _weightLabel.attributedString = [NSString simpleAttributedString:COLOR_TEXT_PRIMARY size:SIZE_TEXT_LARGE content:@"重量"];
...
-(ASTextNode *)volumeLabel{
    if(!_volumeLabel){
        ...
        _volumeLabel.attributedString = [NSString simpleAttributedString:COLOR_TEXT_PRIMARY size:SIZE_TEXT_LARGE content:@"体积"];
...
-(RoundRectNode *)weightTextBack{
    if (!_weightTextBack) {
        ...
        _weightTextBack.cornerRadius = rpx(5);
...
-(ASTextNode *)weightUnitLabel{
    if (!_weightUnitLabel) {
        ...
        _weightUnitLabel.attributedString = [NSString simpleAttributedString:COLOR_TEXT_PRIMARY size:SIZE_TEXT_PRIMARY content:@"Kg"];
...
-(RoundRectNode *)volumeTextBack{
    if (!_volumeTextBack) {
        ...
        _volumeTextBack.cornerRadius = rpx(5);
...
-(ASTextNode *)volumeUnitLabel{
    if (!_volumeUnitLabel) {
        ...
        _volumeUnitLabel.attributedString = [NSString simpleAttributedString:COLOR_TEXT_PRIMARY size:SIZE_TEXT_PRIMARY content:@"m³"];
...
- (void)viewDidLoad {
    ...
    CGFloat const codeBackHeight = rpx(50);
    ...
    self.sourceCodeNode.attributedString = [NSString simpleAttributedString:COLOR_TEXT_PRIMARY size:SIZE_TEXT_LARGE content:self.scanCodeBean.sourceCode];
    ...
    CGFloat const textWidth = self.view.width - leftMargin * 2 - rpx(20);
    ...
    self.weightUnitLabel.x = self.weightTextBack.maxX + rpx(5);
    ...
    self.volumeUnitLabel.x = self.volumeTextBack.maxX + rpx(5);
